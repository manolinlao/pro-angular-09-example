...
@Component({
    selector: 'app-product-old-chapter12',
    templateUrl: './product-old-chapter12.component.html',
    styleUrls: ['./product-old-chapter12.component.css'],
})
export class ProductOldChapter12Component {
